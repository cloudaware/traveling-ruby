...
# export CXXFLAGS="-w"
# export CFLAGS="-w"
export CPPFLAGS="$CPPFLAGS -Wno-error=incompatible-function-pointer-types -Wno-int-conversion"
export CXXFLAGS="$CXXFLAGS -Wno-error=incompatible-function-pointer-types -Wno-int-conversion"
export CFLAGS="$CFLAGS Wno-error=incompatible-function-pointer-types -Wno-int-conversion"
